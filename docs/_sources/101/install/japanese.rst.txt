...
また一部の日本語リソースを修正するためのファイルを、GitHub の `SitecoreaJapan/InstallScript <https://github.com/SitecoreJapan/InstallScript/tree/master/100>`_ のリポジトリに公開しています。以下のファイルをダウンロードしてください。
...
* ここにダウンロード済のファイルを展開します（ Sitecore 10.0.0 rev. 004346 (ja-JP).zip のファイルの中にある ja-jp.xml を temp にコピー）
