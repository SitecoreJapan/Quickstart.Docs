...
Sitecore Connect™ for Sitecore CMP 2.0.0 を利用することで、Content Hub で作成したコンテンツを、Sitecore のアイテムとして追加することができるようになります。
...
Sitecore Connect for Sitecore CMP 2.0.0 は以下のシステムで利用することができます。

* Sitecore Experience Platform 9.3
* Sitecore Experience Manager 9.3
...
.. note:: 本文書は Sitecore Experience Platform 9.3 の内容となっています。
...
* `Sitecore Connect for Sitecore CMP 2.0.0 <https://dev.sitecore.net/Downloads/Sitecore_Connect_for_Sitecore_CMP/20/Sitecore_Connect_for_Sitecore_CMP_200.aspx>`_

この解説では `Sitecore Connect CMP for Sitecore XP 9.2 and 9.3` をダウンロードしてインストールを進めます。
